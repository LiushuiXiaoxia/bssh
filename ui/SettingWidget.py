...
class Ui_SettingWidget(object):
    def setupUi(self, SettingWidget):
        ...
        SettingWidget.resize(912, 871)
        SettingWidget.setMinimumSize(QSize(600, 800))
        self.verticalLayout_4 = QVBoxLayout(SettingWidget)
        self.verticalLayout_4.setObjectName(u"verticalLayout_4")
        self.widget = QWidget(SettingWidget)
    ...
    def retranslateUi(self, SettingWidget):
        ...
        self.label_4.setText(QCoreApplication.translate("SettingWidget", u"\u4e3b\u673a\u5730\u5740", None))
        self.edtHosts.setPlaceholderText(QCoreApplication.translate("SettingWidget", u"\u8bf7\u8f93\u5165\u4e3b\u673a\u5730\u5740\uff0c\u652f\u6301\u591a\u884c\u8f93\u5165", None))
        self.label.setText(QCoreApplication.translate("SettingWidget", u"\u8d26\u53f7", None))
        self.label_2.setText(QCoreApplication.translate("SettingWidget", u"\u5bc6\u7801", None))
        self.edtPassword.setText("")
        self.label_3.setText(QCoreApplication.translate("SettingWidget", u"\u7aef\u53e3", None))
        self.edtPort.setText("")
        self.edtPort.setPlaceholderText(QCoreApplication.translate("SettingWidget", u"22", None))
        self.btnAdd.setText(QCoreApplication.translate("SettingWidget", u"\u6dfb\u52a0", None))
        ___qtablewidgetitem = self.tvClients.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("SettingWidget", u"\u5e8f\u53f7", None));
        ___qtablewidgetitem1 = self.tvClients.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("SettingWidget", u"\u5730\u5740", None));
        ___qtablewidgetitem2 = self.tvClients.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("SettingWidget", u"\u8d26\u53f7", None));
        ___qtablewidgetitem3 = self.tvClients.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("SettingWidget", u"\u7aef\u53e3", None));
        self.btnEdit.setText(QCoreApplication.translate("SettingWidget", u"\u7f16\u8f91", None))
        self.btnRemove.setText(QCoreApplication.translate("SettingWidget", u"\u5220\u9664", None))
        self.btnMoveUp.setText(QCoreApplication.translate("SettingWidget", u"\u4e0a\u79fb", None))
        self.btnMoveDown.setText(QCoreApplication.translate("SettingWidget", u"\u4e0b\u79fb", None))
    # retranslateUi
